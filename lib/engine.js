...
function Engine(config) {
  ...
  this.rateLimiter = require('express-limiter');
...
Engine.prototype.start = function(callback) {
  ...
  this.client = redis.createClient({
    host: process.env.REDIS_HOST || '172.17.200.1',
...
Engine.prototype._configureApp = function() {
  ...
  app.use(helmet());
  this.rateLimiterMiddleware = this.rateLimiter(app, this.client)(this._config.rateLimiter);
