...
StorageEventsCron.prototype.lock = function() {
  const CronJobModel = this.storage.models.StorageEvent;
  CronJobModel.findAndModify({
    query: {
      name: 'StorageEvents',
      locked: false
    },
...
StorageEventsCron.prototype.run = function() {
  log.info('starting to run storage events cron');
