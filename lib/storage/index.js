...
function Storage(options) {
  ...
  this.graphqlSchema = this._createBoundGraphqlSchema(this.models);
...
Storage.prototype._createBoundGraphqlSchema = function(models){
  const graphql = require('../server/graphql');

  return graphql.bindSchema(this.models);
};
