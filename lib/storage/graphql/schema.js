...
module.exports = function(models, req) {
  const paymentProcessorAdapter = require('./payment-processor-adapter')(models);
  ...
  console.log("paymentProcessorEnum: ", paymentProcessorEnum);
  ...
  const addPaymentProcessor = {
    ...
    resolve: function(_, args) {
      ...
      console.log("line 100 schema.js --- addPaymentProcessor");
      ...
      return models.PublicKey.findOne({
        ...
        .catch((err) => (err))
        .then((publicKey)=> {
          console.log("Line 111 publicKey : ", publicKey);
