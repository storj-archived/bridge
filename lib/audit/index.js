 ...
 */
const AuditDispatchPool = function(options) {
  var self = this;
...
AuditDispatchPool.prototype._flushStalePendingQueue = function(callback) {
...
AuditDispatchPool.prototype._initDispatchQueue = function(callback) {
  ...
  while(dispatchQueue.length() < this._options.limit) {
    queueNext(null);
  }
};

new AuditDispatchPool(config);
