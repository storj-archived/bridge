...
Monitor.prototype._replicateFarmer = function(contact) {
  ...
  cursor
    ...
    .on('data', (data) => {
      ...
      // Get the amount of data that is lost
      const contract = shard.getContract(contact);
      const dataSize = contract.get('data_size');
      totalData += dataSize;

      // TODO remove the contract from the shard
    ...
    .on('close', () => {
      ...
      // Decrement the amount of data that this farmer is storing
