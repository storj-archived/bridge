...
function UsersRouter(options) {
  ...
  this._defaults = {
    ...
    onRateLimited: function(req, res, next) {
      ...
      return next(new errors.RateLimited('Slow down, dude.'));
    },
    total: 100,
...
UsersRouter.prototype._definitions = function() {
  return [
    ...
    ['POST', '/activations', this._limiter(this._defaults), rawbody, this.reactivateUser],
    ['GET', '/activations/:token', this._limiter(this._defaults), this.confirmActivateUser],
    ['DELETE', '/users/:id', this._limiter(this._defaults), this._verify, this.destroyUser],
    ['GET', '/deactivations/:token', this._limiter(this._defaults), this.confirmDestroyUser],
    ['PATCH', '/users/:id', this._limiter(this._defaults), rawbody, this.createPasswordResetToken],
    ['GET', '/resets/:token', this._limiter(this._defaults), this.confirmPasswordReset]
  ];
};
