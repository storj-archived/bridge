...
BucketsRouter.prototype._definitions = function() {
  /* jshint maxlen: 140 */
  return [
    ['GET', '/buckets', this._limiter(this._defaults), this._verify, this.getBuckets],
    ['GET', '/buckets/:id', this._limiter(this._defaults), this._validate, this._verify, this.getBucketById],
    ['POST', '/buckets', this._limiter(this._defaults), this._verify, this.createBucket],
    ['DELETE', '/buckets/:id', this._limiter(this._defaults), this._validate, this._verify, this.destroyBucketById],
    ['PATCH', '/buckets/:id', this._limiter(this._defaults), this._validate, this._verify, this.updateBucketById],
    ['POST', '/buckets/:id/tokens', this._limiter(this._defaults), this._validate, this.createBucketToken],
    ['GET', '/buckets/:id/files', this._limiter(this._defaults), this._validate, this._verify, this.listFilesInBucket],
    ['GET', '/buckets/:id/files/:file', this._limiter(this._defaults), this._validate, this._usetoken, this.getFile],
    ['DELETE', '/buckets/:id/files/:file', this._limiter(this._defaults), this._validate, this._verify, this.removeFile],
    ['GET', '/buckets/:id/files/:file/info', this._limiter(this._defaults), this._validate, this.getFileInfo],
    ['POST', '/buckets/:id/files', this._limiter(this._defaults), this._validate, this._verify, this.createEntryFromFrame],
    ['GET', '/buckets/:id/files/:file/mirrors', this._limiter(this._defaults), this._validate, this._verify, this.listMirrorsForFile]
  ];
};
