...
BucketsRouter.prototype._definitions = function() {
  return [
    ...
    ['GET', '/buckets/:id/files/:hash', this._usetoken, this.getFile],
    ['DELETE', '/buckets/:id/files/:hash', this._verify, this.removeFile],
    ['POST', '/buckets/:id/files', this._usetoken , this.createEntryFromFrame]
  ];
};
