...
ContactsRouter.prototype._definitions = function() {
  return [
    ...
    ['PATCH', '/contacts/:nodeID', this.getLimiter(limiter(1000)), this.patchContactByNodeID],
    ['POST', '/contacts', this.getLimiter(limiter(10)), this.createContact],
    ['POST', '/contacts/challenges', this.getLimiter(limiter(100)), this.createChallenge]
  ];
};
