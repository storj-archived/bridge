...
StorageEventRouter.prototype.getStorageEvents = function(req, res, next) {
 ...
 * @param {Function} next
 */
StorageEventRouter.prototype.getStorageEventsByBucket = function(req, res, next) {
  const StorageEvent = this.storage.models.StorageEvent;
 ...
 * @param {Function} next
 */
StorageEventRouter.prototype.getStorageEventsByBucketEntry = function(req, res, next) {
  const StorageEvent = this.storage.models.StorageEvent;
 ...
 * @private
 */
StorageEventRouter.prototype._definitions = function() {
  /* jshint maxlen: 120 */
  return [
