...
PublicKeysRouter.prototype._definitions = function() {
  return [
    ['GET', '/keys', this._limiter(this._defaults), this._verify, this.getPublicKeys],
    ['POST', '/keys', this._limiter(this._defaults), this._verify, this.addPublicKey],
    ['DELETE', '/keys/:pubkey', this._limiter(this._defaults), this._verify, this.destroyPublicKey]
  ];
};
