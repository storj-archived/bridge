...
FramesRouter.prototype._definitions = function() {
  return [
    ...
    ['PUT', '/frames/:frame', this.getLimiter(limiter(1000)), this._verify, this.addShardToFrame],
    ...
    ['GET', '/frames/:frame', this.getLimiter(limiter(5)), this._verify, this.getFrameById]
  ];
};
