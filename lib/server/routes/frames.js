...
FramesRouter.prototype._definitions = function() {
  return [
    ['POST', '/frames', this._limiter(this._defaults), this._verify, this.createFrame],
    ['PUT', '/frames/:frame', this._limiter(this._defaults), this._verify, this.addShardToFrame],
    ['DELETE', '/frames/:frame', this._limiter(this._defaults), this._verify, this.destroyFrameById],
    ['GET', '/frames', this._limiter(this._defaults), this._verify, this.getFrames],
    ['GET', '/frames/:frame', this._limiter(this._defaults), this._verify, this.getFrameById]
  ];
};
