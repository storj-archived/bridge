...
FramesRouter.prototype._definitions = function() {
  return [
    ['POST', '/frames', this.getLimiter(limiter(this._defaults.shardsPerMinute)), this._verify, this.createFrame],
    ['PUT', '/frames/:frame', this.getLimiter(limiter(this._defaults.shardsPerMinute)), this._verify, this.addShardToFrame],
    ['DELETE', '/frames/:frame', this.getLimiter(limiter(this._defaults.shardsPerMinute)), this._verify, this.destroyFrameById],
    ['GET', '/frames', this.getLimiter(limiter(this._defaults.shardsPerMinute)), this._verify, this.getFrames],
    ['GET', '/frames/:frame', this.getLimiter(limiter(this._defaults.shardsPerMinute)), this._verify, this.getFrameById]
  ];
};
