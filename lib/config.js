...
const DEFAULTS = {
  ...
  redis: {
    host: process.env.REDIS_HOST || '172.17.200.1' || '0.0.0.0',
    port: process.env.REDIS_PORT || '6379'
  },
  rateLimiter: {
    total: process.env.LIMITER_TOTAL || 10000,
    expire: process.env.LIMITER_EXPIRE || 1000 * 60 * 60,
    lookup: process.env.LIMITER_LOOKUP || 'connection.remoteAddress',
    method: process.env.LIMITER_METHOD || 'all',
    path: process.env.LIMITER_PATH || '*'
  },
  application: {
