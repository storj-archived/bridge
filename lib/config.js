...
Config.DEFAULTS = {
  ...
  storage: {
    host: process.env.BRIDGE_STORAGE_HOST || '127.0.0.1',
    port: process.env.BRIDGE_STORAGE_PORT || 27017,
    name: process.env.BRIDGE_STORAGE_NAME || `__storj-bridge-${process.env.NODE_ENV || 'develop'}`,
    user: process.env.BRIDGE_STORAGE_USER || null,
    pass: process.env.BRIDGE_STORAGE_PASS || null,
    mongos: JSON.parse(process.env.BRIDGE_STORAGE_MONGOS) || false,
    ssl: process.env.BRIDGE_STORAGE_SSL || false
  },
  audits: {
    adapter: {
