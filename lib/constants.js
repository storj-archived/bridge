...
module.exports = {
  ...
  */
  ...
  /** @constant {Number} DEFAULT_MAX_BUCKETS_CREATED - The default number of
      entries per bucket that can be created.
  */
  DEFAULT_MAX_ENTRIES_CREATED: 2000,
  ...
  */
  DEFAULT_MAX_BUCKETS_CREATED: 5000,
