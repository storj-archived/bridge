...
module.exports = {
  ...
  /** @constant {Number} PUBLISH_BENCH_THRESHOLD - Response time threshold */
  PUBLISH_BENCH_THRESHOLD: 4000,

  /** @constant {Number} PUBLISH_TOTAL - Total number of nodes to publish contracts */
  PUBLISH_TOTAL: 36,

  /** @constant {Number} PUBLISH_TOTAL_BENCH -  Number of publish sent to benchmark nodes */
  PUBLISH_BENCH_TOTAL: 9,
